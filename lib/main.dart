...
class PaginaInicio extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: Text("Bordes en la App de Brisa"),
        centerTitle: true,
      ), //fin appbar
          ...
          child: Column(
            children: [
              ...
              Container(
                ...
                decoration: BoxDecoration(
                  color: Colors.indigo,
                  image: DecorationImage(image: NetworkImage("https://raw.githubusercontent.com/BrisaContreras/Mis_Imagenes/main/185057519_493718121823016_534388446227651723_n%20(1).jpg"), alignment: Alignment.topCenter),
                  border: Border(
                    top: BorderSide(
